...
-- PRODUCTOS
GRANT SELECT, INSERT, DELETE ON WEBMART.PRODUCTOS TO WEBMARTUSER, WEBMARTUSER@localhost;
GRANT UPDATE (ID_SUB,TITULO,DESCRIPCION,PESO,PRECIO,ID_RESERVA,ID_COMPRADOR) ON WEBMART.PRODUCTOS TO WEBMARTUSER, WEBMARTUSER@localhost;
...
GRANT UPDATE (USUARIO,CONTRASEÑA,NOMBRE,APELLIDO1,APELLIDO2,ICONO,CORREO,DIRECCION,DESCRIPCION) ON WEBMART.USUARIOS TO WEBMARTUSER, WEBMARTUSER@localhost;
FLUSH PRIVILEGES;
