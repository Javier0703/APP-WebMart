...
GRANT ALL ON WEBMART.* TO WEBMART WITH GRANT OPTION;
FLUSH PRIVILEGES;

-- USUARIO ADMIN PARA LA DB (UDUARIOS ADMINS DE LA APP)
CREATE USER WEBMARTADMIN IDENTIFIED BY '12345+WebMartAdmin';
GRANT INSERT,DELETE,UPDATE,SELECT ON WEBMART.* TO WEBMARTADMIN;
FLUSH PRIVILEGES;
...
-- CATEGORIAS
GRANT SELECT ON WEBMART.CATEGORIAS TO WEBMARTUSER;

-- CHATS
GRANT SELECT,INSERT ON WEBMART.CHATS TO WEBMARTUSER;
GRANT UPDATE (ULTIMA_CONEX_PROD,ULTIMA_CONEX_USU) ON WEBMART.CHATS TO WEBMARTUSER;

-- CONTRAS_ANTIGUAS
GRANT SELECT,INSERT ON WEBMART.CONTRAS_ANTIGUAS TO WEBMARTUSER;

-- FAVORITOS
GRANT SELECT,INSERT, DELETE ON WEBMART.FAVORITOS TO WEBMARTUSER;

-- FOTOS
GRANT SELECT, INSERT, DELETE ON WEBMART.FOTOS TO WEBMARTUSER;
GRANT UPDATE (FOTO) ON WEBMART.FOTOS TO WEBMARTUSER;

-- MENSAJES
GRANT SELECT, INSERT ON WEBMART.MENSAJES TO WEBMARTUSER;

-- OPINIONES
GRANT SELECT, INSERT, DELETE ON WEBMART.OPINIONES TO WEBMARTUSER;
GRANT UPDATE (VALORACION,MENSAJE) ON WEBMART.OPINIONES TO WEBMARTUSER;

-- PRODUCTOS
GRANT SELECT, INSERT ON WEBMART.PRODUCTOS TO WEBMARTUSER;
GRANT UPDATE (ID_CAT,TITULO,DESCRIPCION,PESO,PESO,ID_RESERVA,ID_COMPRADOR) ON WEBMART.PRODUCTOS TO WEBMARTUSER;

-- RESERVAS
GRANT SELECT, INSERT, DELETE ON WEBMART.RESERVAS TO WEBMARTUSER;

-- USUARIOS
GRANT INSERT, SELECT ON WEBMART.USUARIOS TO WEBMARTUSER;
GRANT UPDATE (USUARIO,CONTRASEÑA,NOMBRE,APELLIDO1,APELLIDO2,CORREO,DIRECCION) ON WEBMART.USUARIOS TO WEBMARTUSER;
FLUSH PRIVILEGES;
